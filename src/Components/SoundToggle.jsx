...
export default function SoundToggle() {
  ...
  return (
    <button
      onClick={handleClick}
      className="w-10 h-10 md:w-11 md:h-11 rounded-full backdrop-blur-xl bg-white/10 border border-white/20 flex items-center justify-center hover:bg-white/20 transition-all duration-300 hover:scale-110 shadow-lg group cursor-pointer"
