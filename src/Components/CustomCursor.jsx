...
export default function CustomCursor() {
  ...
  const trailColor = isDark
    ? "rgba(251, 191, 36, 0.85)" // Amber trail for dark
    : "rgba(59, 130, 246, 0.8)"; // Blue trail for light

  const glowColor = isDark
    ? "rgba(251, 191, 36, 0.9)" // Amber glow
    : "rgba(59, 130, 246, 0.85)"; // Blue glow
      ...
      >
        ...
        >
          ...
          <path
            ...
            fill={cursorColor}
            stroke={
              isDark ? "rgba(251, 191, 36, 0.5)" : "rgba(59, 130, 246, 0.5)"
            }
            strokeWidth="0.5"
          />
          {/* Inner highlight */}
          <path
            d="M2 2L8.5 15L10.5 10.5L15 8.5L2 2Z"
            fill={
              isDark ? "rgba(251, 191, 36, 0.2)" : "rgba(59, 130, 246, 0.2)"
            }
