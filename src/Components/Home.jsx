    ...
    >
      ...
      <div className="container mx-auto px-6 pt-16 md:pt-0 text-center relative z-10">
        <div className="space-y-6 animate-fade-in">
          ...
          >
            I build scalable, high-performance web and desktop applications
            using modern MERN stack technologies and Electron.js. Specializing
            in creating intuitive user experiences, robust backend solutions,
            and cross-platform desktop applications for ambitious teams and
            growing businesses.
          </p>

          {/* Quick value chips */}
          <div
            className="flex flex-wrap justify-center gap-3 pt-2 reveal-stagger"
            style={{ "--stagger-delay": "540ms" }}
          >
            <span className="px-4 py-1.5 rounded-full border border-white/10 bg-white/5 text-xs md:text-sm text-slate-300 tracking-wide">
              5+ production-ready projects
            </span>
            <span className="px-4 py-1.5 rounded-full border border-white/10 bg-white/5 text-xs md:text-sm text-slate-300 tracking-wide">
              Performance-first MERN stack
            </span>
            <span className="px-4 py-1.5 rounded-full border border-white/10 bg-white/5 text-xs md:text-sm text-slate-300 tracking-wide">
              Desktop Apps with Electron.js
            </span>
            <span className="px-4 py-1.5 rounded-full border border-white/10 bg-white/5 text-xs md:text-sm text-slate-300 tracking-wide">
              Pixel-perfect, animated UI
            </span>
          </div>
