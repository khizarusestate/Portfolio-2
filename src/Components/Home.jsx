    ...
    >
      ...
      <div className="container mx-auto px-6 pt-16 md:pt-0 text-center relative z-10">
        <div className="space-y-6 animate-fade-in">
          ...
          >
            I design and ship production-ready MERN experiences for startups and small
            businesses – from polished landing pages to full dashboards – with a focus
            on speed, clean code, and modern UI.
          </p>
