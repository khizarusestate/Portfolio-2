      ...
      <div className="relative">
        <div className="relative overflow-hidden rounded-t-3xl bg-slate-950/40">
          {isGallery ? (
            ...
            <>
              {!desktopLoaded[0] && <div className="absolute inset-0 loading-shimmer"></div>}
              <img
                src={desktopImages[0]}
...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      downloadUrl: '/Assets/Downloads/Tabify.exe',
      layout: 'wide',
      hideProjectTag: true,
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid gap-10 md:grid-cols-2 xl:grid-cols-3">
          {projects.map((project, index) => (
            <div
              key={project.title}
              className={project.layout === 'wide' ? 'md:col-span-2 xl:col-span-3' : ''}
            >
