            ...
            <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className={`group relative w-full px-8 py-4 border-2 border-slate-400/30 rounded-full font-semibold text-slate-50 backdrop-blur-sm bg-white/5 overflow-hidden transition-all duration-300 ${
              ...
              <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl">
                ...
                <div className="space-y-3">
                  <a
                    ...
                    className="group flex items-center space-x-3 text-slate-400 hover:text-slate-200 transition-all duration-300 p-3 rounded-lg border border-transparent hover:bg-white/5 theme-dark:hover:border-amber-400/40 theme-light:hover:border-sky-600/40"
                  >
                    <svg
                      className="w-5 h-5 theme-dark:text-amber-400 theme-light:text-sky-600"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <span className="group-hover:underline">khizarusestate@gmail.com</span>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <span className="group-hover:underline">+923277522098</span>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <span className="group-hover:underline">Gujranwala Punjab Pakistan</span>
                  </a>
                </div>
              </div>
            </div>
