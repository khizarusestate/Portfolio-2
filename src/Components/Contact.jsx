  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          payload?.message ||
            "Unable to send your message. Please check your details.",
        );
      }
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p
              className={`text-slate-400 text-lg max-w-2xl mx-auto ${isVisible ? "reveal-stagger" : "opacity-0"}`}
              style={{ "--stagger-delay": "190ms" }}
            >
              Ready to discuss your next project? I'm here to collaborate on
              innovative solutions and bring your vision to life.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            {/* Social Links & Info */}
            <div
              className={`space-y-8 ${isVisible ? "reveal-stagger" : "opacity-0"}`}
              style={{ "--stagger-delay": "360ms" }}
            >
              {/* Social Links */}
              ...
              <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl">
                ...
                <p className="text-slate-400 leading-relaxed mb-4">
                  I usually work best on focused, high-impact projects where I
                  can own both the UX and the engineering – from the first
                  layout all the way to deployment.
                </p>
