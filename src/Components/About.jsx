        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <p className={`text-slate-400 text-lg leading-relaxed ${isVisible ? 'reveal-stagger' : 'opacity-0'}`} style={{ '--stagger-delay': '180ms' }}>
              ...
              <p className={`text-slate-400 text-lg leading-relaxed ${isVisible ? 'reveal-stagger' : 'opacity-0'}`} style={{ '--stagger-delay': '280ms' }}>
              ...
              <p className={`text-slate-400 text-lg leading-relaxed ${isVisible ? 'reveal-stagger' : 'opacity-0'}`} style={{ '--stagger-delay': '360ms' }}>
            ...
            {/* Skills Card */}
            <div className={`relative ${isVisible ? 'reveal-stagger' : 'opacity-0'}`} style={{ '--stagger-delay': '250ms' }}>
