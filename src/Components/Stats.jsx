...
export default function Stats() {
  ...
  const stats = [
    { number: 5, suffix: '+', label: 'Production-ready projects shipped' },
    { number: 90, suffix: '+', label: 'Lighthouse scores on recent builds' },
    { number: 2, suffix: '+', label: 'Years focused on MERN' },
  ]
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-10">
          ...
          <p className="text-slate-400">
            A quick snapshot of the kind of work and quality I aim for in every
            project.
          </p>
        </div>
